    ...
    >
      ...
      <Form.Item>
        <Radio.Group onChange={onChange} value={value}>
          <Space direction="horizontal">
            <Radio className="f" value={1}>
              Female
            </Radio>
            <Radio className="f" value={2}>
              Male
            </Radio>
            <Radio className="f" value={3}>
              Other
            </Radio>
          </Space>
        </Radio.Group>
      ...
      >
        ...
        <p>
          ...
          to Facebook. Learn more. By clicking Sign Up, you agree to our Terms,
      ...
      <Form.Item>
        <Button
          type="primary"
          htmlType="submit"
          className="login-form-button btn3"
        >
          Sign Up
        </Button>
      </Form.Item>
